...
function DataAnalytics() {
  ...
  <section className="benefits-section container">
        <div className="benefit-item">
          <img
            src="/img/dataAnalytics/19466.jpg"
        ...
        <div className="benefit-item">
          <img
            src="/img/dataAnalytics/deci.jpg"
        ...
        <div className="benefit-item customer-insight">
          <img
            src="/img/dataAnalytics/cust.jpg"
            alt="Customer Insights"
            className="benefit-image imagelayout"
          />
          <h2 className="customer-insight-heading">Enhanced Customer Insights</h2>
          <p>
